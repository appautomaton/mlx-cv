"""Repository-only golden-fixture parity contract and bisection harness.

Parity cases contain fixed-input reference outputs and optional intermediate
*taps*. :func:`bisect` localizes a divergence to the first tap that drifts,
turning "the boxes are wrong" into "the projector is wrong".
"""
